      ...
      <Card sx={{ maxWidth: 350, margin: "60px auto" }}>
        ...
        <CardContent>
          <Typography variant="body2" color="text.secondary">
            ...
            사항은 법률로 정한다. 제1항의 해임건의는 국회재적의원 3분의 1 이상의
            발의에 의하여 국회재적의원 과반수의 찬성이 있어야 한다.
          </Typography>
        </CardContent>
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              ...
              법령의 범위안에서 자치에 관한 규정을 제정할 수 있다. 대통령의
              임기는 5년으로 하며, 중임할 수 없다.
            </Typography>
            <Typography paragraph>
              헌법재판소는 법률에 저촉되지 아니하는 범위안에서 심판에 관한 절차,
              내부규율과 사무처리에 관한 규칙을 제정할 수 있다. 대통령은 조약을
              체결·비준하고, 외교사절을 신임·접수 또는 파견하며, 선전포고와
              강화를 한다. 모든 국민의 재산권은 보장된다. 그 내용과 한계는
              법률로 정한다. 헌법개정은 국회재적의원 과반수 또는 대통령의 발의로
              제안된다.
            </Typography>
            <Typography paragraph>
        ...
        <Collapse in={expanded2} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>
              ...
              소비자보호운동을 법률이 정하는 바에 의하여 보장한다. 재의의 요구가
